...
public final class BwaSparkEngine implements AutoCloseable {
    ...
    private static final class ReadAligner {
        ...
        Iterator<GATKRead> apply( Iterator<GATKRead> readItr ) {
            ...
            final List<List<Alignment>> allAlignments;
            ...
            for ( int idx = 0; idx != nReads; ++idx ) {
                ...
                final List<Alignment> alignments = allAlignments.get(idx);
                ...
                for ( final Alignment alignment : alignments ) {
                    final GATKRead rec = alignment.apply(originalRead, refNames, readsHeader, false, true);
                    if ( nPrimaries > 1 ) {
                        ...
                        alignments.stream()
                                ...
                                .forEach(aln->saTag.append(aln.asTag(refNames)));
