...
class AlignmentRegion {
    ...
    public AlignmentRegion(final String assemblyId, final String contigId, final int contigLen, final Alignment alignment, final List<String> refNames) {
        this.contigId = contigId;
        this.assemblyId = assemblyId;
        this.forwardStrand = (alignment.getSamFlag()& SAMFlag.READ_REVERSE_STRAND.intValue())==0;
        this.forwardStrandCigar = alignment.getCigar();
