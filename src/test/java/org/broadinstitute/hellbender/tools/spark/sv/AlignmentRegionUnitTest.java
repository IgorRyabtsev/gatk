...
public class AlignmentRegionUnitTest {
    ...
    private Alignment createAlignment( final boolean fwdStrand, final int refStart, final int tigStart, final String cigar, final int nMismatches ) {
        return new Alignment( fwdStrand ? 0 : SAMFlag.READ_REVERSE_STRAND.intValue(),
                                0, refStart, refStart+4, tigStart, tigStart+4, 60, nMismatches,
                                0, 0, TextCigarCodec.decode(cigar), null, null,
                                0, refStart+100, 104);
    }
    @Test
